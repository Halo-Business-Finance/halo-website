          ...
          <div className="max-w-3xl">
            <div className="text-white space-y-6">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 animate-fade-in">
                ...
                <span className="text-sm text-white/90">Over $1+ Billion Funded</span>
              </div>
              ...
              <p className="text-base md:text-lg text-white/90 max-w-2xl leading-relaxed animate-fade-in" style={{
              animationDelay: '0.2s'
            }}>
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 pt-2 animate-fade-in" style={{
              animationDelay: '0.3s'
            }}>
                ...
                <Button size="lg" variant="outline" className="glass-outline text-white font-semibold px-8 py-6 rounded-xl transition-all duration-300 hover:scale-105" asChild>
              ...
              animationDelay: '0.4s'
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-white/90">SBA Preferred Lenders</span>
                </div>
              </div>

              {/* Quick Stats - Mobile Only */}
              <div className="grid grid-cols-3 gap-4 pt-4 md:hidden animate-fade-in" style={{
              animationDelay: '0.5s'
            }}>
                {quickStats.map((stat, index) => <div key={index} className="text-center p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/10">
