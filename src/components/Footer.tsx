        ...
        <div className="border-t border-white/20 pt-8">
          ...
          <div className="mt-8 pt-6 border-t border-white/20">
            <div className="text-xs text-white space-y-2">
              ...
              <p className="hidden md:block">DFPI CFL License No. 60DBO-178064. California Commercial Financing Law disclosures available upon request.</p>
              <p className="hidden md:block">NMLS ID: 2272778. Commercial Loan Marketplace. Loan programs subject to credit approval and terms may vary by lender.</p>
