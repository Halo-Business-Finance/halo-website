      ...
      <div className="border-b border-white/10" style={{ backgroundColor: '#0d1f35' }}>
        <div className="max-w-[1400px] mx-auto">
          <div className="flex items-center justify-between h-14 px-4 sm:px-8">
            ...
            {/* Logo */}
            <Link to="/" className={`flex items-center transition-all duration-300 ${isOpen ? 'justify-center flex-1' : 'lg:flex-none flex-1 lg:flex-initial justify-center lg:justify-start lg:ml-2'}`}>
