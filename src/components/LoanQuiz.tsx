      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Answer a few quick questions to get personalized loan recommendations tailored to your business needs.
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {getRecommendations().map((loan) => (
                  <Card key={loan.id} className="border-border/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
