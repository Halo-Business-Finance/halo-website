      ...
      <div className="max-w-8xl mx-auto px-4 relative z-10">{/* Increased from container to max-w-8xl for wider layout */}
        ...
        <div className="pt-16">
          <div className="text-left mb-6 max-w-7xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4 underline decoration-2 text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12 max-w-7xl mx-auto">
           ...
           <div className="text-center max-w-7xl mx-auto mt-6">
             <p className="text-2xl text-gray-900 max-w-2xl whitespace-nowrap text-center mx-auto font-sans">
