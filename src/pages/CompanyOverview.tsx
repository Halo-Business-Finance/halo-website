            ...
            <Card className="p-8">
              <CardContent className="p-0">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-sm">SBA Nationwide SBA & Commercial Loan Marketplace for government-backed loans</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
            ...
            <Card className="p-8">
              <CardContent className="p-0">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-sm">SBA Nationwide SBA & Commercial Loan Marketplace participant</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-muted/50 rounded-lg p-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold mb-2">SBA Nationwide SBA & Commercial Loan Marketplace</h4>
                <p className="text-sm text-muted-foreground">
