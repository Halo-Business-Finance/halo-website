...
const conventionalLoanSchema = z.object({
  ...
  cashFlow: z.string().min(1, "Monthly cash flow is required"),
...
type ConventionalLoanFormData = z.infer<typeof conventionalLoanSchema>;

const ConventionalLoanApplication = () => {
  const [currentStep, setCurrentStep] = useState(1);
  const { toast } = useToast();
  
  const form = useForm<ConventionalLoanFormData>({
    resolver: zodResolver(conventionalLoanSchema),
    defaultValues: {
  ...
  return (
    <>
      <SEO 
        title="Conventional Loan Application"
        description="Apply for a conventional business loan with competitive rates and flexible terms for established businesses."
        canonical="/conventional-loan-application"
      />
      
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-foreground mb-2">Conventional Loan Application</h1>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea placeholder="Describe the collateral you can offer to secure this loan" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                  ...
                  {currentStep === 5 && (
                    <div className="space-y-4">
                      ...
                      <p className="text-foreground">
                        Please review all information before submitting your conventional loan application.
                      </p>
...
export default ConventionalLoanApplication;