  ...
  return (
    <>
      <SEO 
        ...
        description="SBA Nationwide Marketplace offering SBA 7(a) loans up to $5M, SBA 504 loans, Express loans, and microloans. Fast approval, competitive rates, expert guidance."
        keywords="SBA loans, SBA 7a loans, SBA 504 loans, SBA express loans, SBA microloans, SBA nationwide marketplace, small business administration loans, government backed loans, business financing, commercial loans"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <div className="flex items-center gap-4 mb-6">
                ...
                />
                <Badge className="bg-white text-primary">SBA Nationwide Marketplace</Badge>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                SBA Loan Solutions for Every Business Need
              </h1>
              <p className="text-xl mb-8 opacity-90">
                As an SBA Nationwide Marketplace, we offer the full range of SBA loan programs with faster processing, competitive rates, and expert guidance from application to funding.
              </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Over 2,000 businesses funded with $1.5B+ in SBA loans, helping companies achieve their growth goals.</p>
                </div>
              </div>
