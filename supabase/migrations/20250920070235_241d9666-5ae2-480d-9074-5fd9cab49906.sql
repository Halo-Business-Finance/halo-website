-- Drop existing function with CASCADE to update dependent policies
DROP FUNCTION IF EXISTS public.verify_active_session_with_mfa(text, integer) CASCADE;

-- Recreate missing security functions
...
-- Function to verify active session with MFA (recreate with correct parameters)
