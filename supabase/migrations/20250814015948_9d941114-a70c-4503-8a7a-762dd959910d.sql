-- Critical Security Fix: Admin Role Management Vulnerability (Fixed Trigger Syntax)
...
-- Apply the enhanced trigger to consultations table (INSERT, UPDATE, DELETE only)
