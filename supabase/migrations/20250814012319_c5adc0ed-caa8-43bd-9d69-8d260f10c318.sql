...
-- Create a dedicated service role for the security API
-- This allows the edge function to access data while blocking direct API access
...
INSERT INTO public.security_events (
  ...
  'security_infrastructure_isolated',
  'info',
  jsonb_build_object(
    'isolated_tables', ARRAY['security_events', 'security_alerts', 'security_configs', 'rate_limit_configs'],
    'access_method', 'edge_function_only',
