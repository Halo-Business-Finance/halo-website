-- =============================================================================
-- CRITICAL SECURITY FIX: Admin Sessions Protection
-- =============================================================================
...
-- 8. Create admin session monitoring trigger
...
CREATE TRIGGER admin_session_access_monitor
  AFTER SELECT OR INSERT OR UPDATE OR DELETE ON public.admin_sessions
